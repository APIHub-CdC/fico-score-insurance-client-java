package io.FicoScoreInsurance.client.model;
...
public class Persona {
  ...
  @ApiModelProperty(example = "07-01-1980", required = true, value = "Fecha de nacimiento de la persona, en el formato especificado (por defecto dd-MM-yyyy)")
